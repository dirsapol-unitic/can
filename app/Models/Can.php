...
class Can extends Model
{
    ...
    public static function ContarMedicamentoCerrado($can_id, $establecimiento_id) {
        $cad = "select count(*) as total
            from can_servicio
            where can_id='{$can_id}' and establecimiento_id ='{$establecimiento_id}' and 
    ...
    public static function RegistrarProductosElegidosNivel2y3($can_id, $nivel, $tipo, $establecimiento_id,$codigo_establecimiento, $nombre_establecimiento, $petitorios, $servicio_id, $nombre_servicio) {

        $cad = "Select sp_insert_productos_elegidos_nivel2y3(?,?,?,?,?,?,?,?,?)";
        $data = DB::select($cad, array($can_id, $nivel, $tipo,$establecimiento_id,$codigo_establecimiento,$nombre_establecimiento,$petitorios,$servicio_id,$nombre_servicio));
    ...
    public static function BuscaCanEstablecimientoServicio($can_id, $establecimiento_id, $servicio_id) {
        $cad = "select count(*) as total
            from can_servicio
            where can_id='{$can_id}' and servicio_id='{$servicio_id}' and establecimiento_id='{$establecimiento_id}' ";
    ...
    public static function CopiarProductosCanAnteriorNivel1($can_id, $tipo, $establecimiento_id) {

        $cad = "Select sp_copiar_can_anterior_nivel_1(?,?,?)";
        $data = DB::select($cad, array($can_id, $tipo, $establecimiento_id));
    ...
    public static function CopiarProductosCanAnteriorServicioNivel2y3($can_id, $tipo, $establecimiento_id, $servicio_id) {

        $cad = "Select sp_copiar_can_anterior_nivel_2y3(?,?,?,?)";
        $data = DB::select($cad, array($can_id, $tipo, $establecimiento_id, $servicio_id));
