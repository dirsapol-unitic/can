                        ...
                        @foreach($cans as $can)
                            ...
                            @else
                                <tr>
                                    ...
                                    @if ($can->id==9 )
                                    <td>
                                        @if ($can->actualizacion==1 )
                                            SI
                                        @else
                                            <a href="{!! route('farmacia.actualizar_can_2027', ['can_id'=>$can->id,'establecimiento'=>$can->establecimiento_id]) !!}" class='btn bg-primary btn-md'><i class="fa fa-check"></i></a>
                                        @endif
                                    </td>
                                    @else
                                    <td></td>
