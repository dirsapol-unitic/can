        ...
        <div class="content">
            ...
            <div class="box box">
                <div class="box-body">
                    ...
                    @include('site.responsable_farmacia.medicamentos.form_rectificar')
                    @include('site.responsable_farmacia.medicamentos.form_ver_rectificar')
            </div>
...
<!-- Bootstrap core JavaScript
    ...
    <script type="text/javascript">
      ...
      function editForm(id) {
        ...
        $('#modal-form-rectificar form')[0].reset();
        $.ajax({          
          url: "{{ url('farmacia') }}" + "/" +id + "/edit",
          type: "GET",
          dataType: "JSON",
          success: function(data) {
            $('#modal-form-rectificar').modal('show');
      ...
      $(function(){
            $('#modal-form-rectificar form').validator().on('submit', function (e) {
            ...
            if (!e.isDefaultPrevented()){
                ...
                $.ajax({
                    url : url,
                    type : "POST",
                    data: new FormData($("#modal-form-rectificar form")[0]),
                    contentType: false,
                    processData: false,
                    success : function(data) {
                        $('#modal-form-rectificar').modal('hide');
                        table.ajax.reload();
                        swal({
                            title: 'Excelente!',
                            text: data.message,
