                ...
                <div class="box-body">
                    ...
                    @if($medicamento_cerrado_consolidado==1)
                        <h1 class="pull-right">
                          ...
                          @endif
                            <a class="btn btn-app" href="{!! route('farmacia.exportEstimacionDataConsolidada',[$can_id,$establecimiento_id,$tipo,'xlsx',$valor]) !!}">
                    ...
                    @else
                      @include('site.responsable_farmacia.medicamentos.form_stock')
                      @include('site.responsable_farmacia.medicamentos.form_ver')
      ...
      function editForm(id) {
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            //cpma_stock=data.necesidad_anual/12;
            //cpma_stock=Math.round(data.necesidad_anual/12 * 100) / 100;
            ...
            if(requerimiento>0){
              ...
              var nivel = $('#nivel_farma').val();
                ...
                if (nivel == 1 ) {  
                  ...
                  cpma_calculo =   Math.round(necesidad/12); //10
                  cpmmin = cpma_calculo-cpma_calculo*0.25;  //7.5
                  cpmmax = cpma_calculo+cpma_calculo*0.35; //13.5
                  
                  if (cpma<=cpmmin) {
                    swal("El CPMA no debe ser menor a : "+cpmmin+" + ni  mayor a : "+cpmmax+" ");
                    return false;
                  }
                  if (cpma>=cpmmax) {
                    swal("El CPMA no debe ser menor a : "+cpmmin+" + ni  mayor a : "+cpmmax+" ");
