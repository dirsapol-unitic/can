...
<div class="modal" id="modal-form-rectificar" tabindex="1" role="dialog" aria-hidden="true" data-backdrop="static">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-4 form-group has-error">                        
                            <div class="input-group">
                                ...
                                <input style="font-size:12px;" type="number" min="0" id="necesidad_actual" placeholder="Nueva Necesidad Anual" name="necesidad_actual" required class="form-control necesidad">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-3 form-group has-error">                        
                            <div class="input-group">
                                ...
                                <input style="font-size:12px;" type="number" min="0" step="any" id="cpma" placeholder="CPMA"  disabled name="cpma" required class="form-control cpm" onkeyup="calculo();">
                                <span style="font-size:9px;" class="help-block with-errors"></span>
                            </div>                           
                        </div>
                        <div class="col-md-1">
                        ...
                        <div class="col-md-3 form-group has-error">
                            <div class="input-group">
                                <span class="input-group-addon" style="font-size:12px;"><b> Stock</b></span>
