        ...
        <div class="modal-content">
            <form id="form_contact" method="post" class="form-horizontal" data-toggle="validator" enctype="multipart/form-data">
                ...
                <div class="box-body">
                    ...
                    <input type="hidden" id="nivel_farma" name="nivel_farma" value="<?php echo $nivel;?>" />
                    <div class="col-md-12">
                        <div class="col-md-1">
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-3 form-group has-error">                        
                            <div class="input-group">
                                ...
                                <input style="font-size:12px;" type="number" min="0" step="any" id="cpma" placeholder="CPMA"  name="cpma" required class="form-control cpm">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-3 form-group has-error"> 
                            <div class="input-group">
                                ...
                                <input style="font-size:12px;" type="number" min="0" id="mes1" placeholder="Enero"  name="mes1" required disabled class="form-control suma_mes" onkeyup="suma_meses();">
                                <span style="font-size:9px;" class="help-block with-errors"></span>
                            </div>                           
                        </div>
                        <div class="col-md-1">
                        ...
                        <div class="col-md-3 form-group has-error">                     
                            <div class="input-group">
                                ...
                                <input style="font-size:12px;" type="number" min="0" id="mes2" placeholder="Febrero"  name="mes2" required  disabled class="form-control suma_mes" onkeyup="suma_meses();">
                                <span style="font-size:9px;" class="help-block with-errors"></span>
                            </div>                           
                        </div>
                        <div class="col-md-1">
                        ...
                        <div class="col-md-3 form-group has-error">
                            <div class="input-group">
                                ...
                                <input style="font-size:12px;" type="number" min="0" id="mes3" placeholder="Marzo"  name="mes3" required disabled class="form-control suma_mes" onkeyup="suma_meses();">
                                <span style="font-size:9px;" class="help-block with-errors"></span>
                            </div>                           
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-3 form-group has-error">                        
                            <div class="input-group">
                                ...
                                <input style="font-size:12px;" type="number" min="0" id="mes4" placeholder="Abril"  name="mes4" required disabled class="form-control suma_mes" onkeyup="suma_meses();">
                                <span style="font-size:9px;" class="help-block with-errors"></span>
                            </div>                           
                        </div>                        
                        <div class="col-md-1">
                        ...
                        <div class="col-md-3 form-group has-error">
                            <div class="input-group">
                                ...
                                <input style="font-size:12px;" type="number" min="0" id="mes5" placeholder="Mayo"  name="mes5" required disabled class="form-control suma_mes" onkeyup="suma_meses();">
                                <span style="font-size:9px;" class="help-block with-errors"></span>
                            </div>                           
                        </div>
                        <div class="col-md-1">
                        ...
                        <div class="col-md-3 form-group has-error">                        
                            <div class="input-group">
                                ...
                                <input style="font-size:12px;" type="number" min="0" id="mes6" placeholder="Junio"  name="mes6" required disabled class="form-control suma_mes" onkeyup="suma_meses();">
                                <span style="font-size:9px;" class="help-block with-errors"></span>
                            </div>                           
                        </div>
                    </div>
                    <div class="col-md-12">
                        ...
                        <div class="col-md-3 form-group has-error">
                            <div class="input-group">
                                ...
                                <input style="font-size:12px;" type="number" min="0" id="mes7" placeholder="Julio"  name="mes7" required disabled class="form-control suma_mes" onkeyup="suma_meses();">
                                <span style="font-size:9px;" class="help-block with-errors"></span>
                            </div>                           
                        </div>
                        <div class="col-md-1">
                        ...
                        <div class="col-md-3 form-group has-error">                        
                            <div class="input-group">
                                ...
                                <input style="font-size:12px;" type="number" min="0" id="mes8" placeholder="Agosto"  name="mes8" required disabled class="form-control suma_mes" onkeyup="suma_meses();">
                                <span style="font-size:9px;" class="help-block with-errors"></span>
                            </div>                           
                        </div>
                        <div class="col-md-1">
                        ...
                        <div class="col-md-3 form-group has-error">
                            <div class="input-group">
                                ...
                                <input style="font-size:12px;" type="number" min="0" id="mes9" placeholder="Setiembre"  name="mes9" required disabled class="form-control suma_mes" onkeyup="suma_meses();">
                                <span style="font-size:9px;" class="help-block with-errors"></span>
                            </div>                           
                        </div>                        
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-3 form-group has-error">                        
                            <div class="input-group">
                                ...
                                <input style="font-size:12px;" type="number" min="0" id="mes10" placeholder="Octubre"  name="mes10" required disabled class="form-control suma_mes" onkeyup="suma_meses();">
                                <span style="font-size:9px;" class="help-block with-errors"></span>
                            </div>                           
                        </div>
                        <div class="col-md-1">
                        ...
                        <div class="col-md-3 form-group has-error">
                            <div class="input-group">
                                ...
                                <input style="font-size:12px;" type="number" min="0" id="mes11" placeholder="Noviembre"  name="mes11" disabled required class="form-control suma_mes" onkeyup="suma_meses();">
                                <span style="font-size:9px;" class="help-block with-errors"></span>
                            </div>                           
                        </div>
                        <div class="col-md-1">
                        ...
                        <div class="col-md-3 form-group has-error">                        
                            <div class="input-group">
                                ...
                                <input style="font-size:12px;" type="number" min="0" id="mes12" placeholder="Diciembre"  name="mes12" disabled required class="form-control suma_mes" onkeyup="suma_meses();">
                                <span style="font-size:9px;" class="help-block with-errors"></span>
                            </div>                           
                        </div>                        
                    </div>
