...
@section('content')
    ...
    <div class="content">
        ...
        <div class="box box-primary">
            <div class="box-body">
                <div class="row">
                    {!! Form::open(['route' => ['farmacia.grabar_nuevo_medicamento_dispositivo',$establecimiento_id,$can_id,$destino],'method' => 'post']) !!}

                        @include('site.responsable_farmacia.nuevo.fields')
