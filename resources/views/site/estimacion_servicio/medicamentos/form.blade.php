        ...
        <div class="modal-content">
            <form id="form_contact" method="post" class="form-horizontal" data-toggle="validator" enctype="multipart/form-data">
                            ...
                            <thead>
                                ...
                                <tr> 
                                    <td style="text-align:center;">
                                        <div class="form-group has-error input-group">
                                            ...
                                            <input style="font-size:12px;" tabindex="1" type="number" min="0" id="necesidad_anual" placeholder="Necesidad Anual"  name="necesidad_anual" required  class="form-control necesidad" onkeyup="sumar_necesidad();">
                                        ...
                                        <div class="form-group has-error input-group">
                                            ...
                                            <input style="font-size:12px;" type="number" tabindex="6" min="0" id="mes5" placeholder="Mayo"  name="mes5" required  class="form-control suma_mes" onkeyup="suma_meses();">
                                            <span style="font-size:9px;" class="help-block with-errors"></span>
                                        </div>
                                        <div class="form-group has-error input-group">
                                            <span class="input-group-addon" style="font-size:12px;"><b> Octubre</b></span>
                                            <input style="font-size:12px;" type="number" tabindex="11" min="0" id="mes10" placeholder="Octubre"  name="mes10" required  class="form-control suma_mes" onkeyup="suma_meses();">
                                            <span style="font-size:9px;" class="help-block with-errors"></span>
                                        </div>
                                    </td>
                                    <td style="text-align:center;">
                                        <div class="form-group has-error input-group">
                                            ...
                                            <input style="font-size:12px;" tabindex="2" type="number" min="0" id="mes1" placeholder="Enero"  name="mes1" required  class="form-control suma_mes" onkeyup="suma_meses();">
                                            <span style="font-size:9px;" class="help-block with-errors"></span>
                                        </div>
                                        <div class="form-group has-error input-group">
                                            <span class="input-group-addon" style="font-size:12px;"><b> Junio</b></span>
                                            <input style="font-size:12px;" type="number" min="0" id="mes6" placeholder="Junio"  name="mes6" required  class="form-control suma_mes" tabindex="7" onkeyup="suma_meses();">
                                            <span style="font-size:9px;" class="help-block with-errors"></span>
                                        </div>
                                        <div class="form-group has-error input-group">
                                            <span class="input-group-addon" style="font-size:12px;"><b> Noviembre</b></span>
                                            <input style="font-size:12px;" type="number" min="0" id="mes11" placeholder="Noviembre"  name="mes11"  required class="form-control suma_mes" tabindex="12" onkeyup="suma_meses();">
                                            <span style="font-size:9px;" class="help-block with-errors"></span>
                                        </div>
                                    </td>
                                    <td style="text-align:center;">
                                        <div class="form-group has-error input-group">
                                            ...
                                            <input style="font-size:12px;" tabindex="3" type="number" min="0" id="mes2" placeholder="Febrero"  name="mes2" required   class="form-control suma_mes" onkeyup="suma_meses();">
                                            <span style="font-size:9px;" class="help-block with-errors"></span>
                                        </div>
                                        <div class="form-group has-error input-group">
                                            <span class="input-group-addon" style="font-size:12px;"><b> Julio</b></span>
                                            <input style="font-size:12px;" type="number" min="0" tabindex="8" id="mes7" placeholder="Julio"  name="mes7" required  class="form-control suma_mes" onkeyup="suma_meses();">
                                            <span style="font-size:9px;" class="help-block with-errors"></span>
                                        </div>
                                        <div class="form-group has-error input-group">
                                            <span class="input-group-addon" style="font-size:12px;"><b> Diciembre</b></span>
                                            <input tabindex="13" style="font-size:12px;" type="number" min="0" id="mes12" placeholder="Diciembre"  name="mes12"  required class="form-control suma_mes" onkeyup="suma_meses();">
                                            <span style="font-size:9px;" class="help-block with-errors"></span>
                                        </div> 
                                    </td>
                                    <td style="text-align:center;">
                                        <div class="form-group has-error input-group">
                                            ...
                                            <input style="font-size:12px;" tabindex="4" type="number" min="0" id="mes3" placeholder="Marzo"  name="mes3" required  class="form-control suma_mes" onkeyup="suma_meses();">
                                            <span style="font-size:9px;" class="help-block with-errors"></span>
                                        </div>
                                        <div class="form-group has-error input-group">
                                            <span class="input-group-addon" style="font-size:12px;"><b> Agosto</b></span>
                                            <input style="font-size:12px;" type="number" tabindex="9" min="0" id="mes8" placeholder="Agosto"  name="mes8" required  class="form-control suma_mes" onkeyup="suma_meses();">
                                            <span style="font-size:9px;" class="help-block with-errors"></span>
                                        </div>
                                        <div class="form-group has-error input-group">
                                            <button type="button" tabindex="14"  onclick="getDividir()"> 
                                              Dividir
                                            </button> 
                                            <button type="button" tabindex="15"  onclick="limpiar_imput1()"> 
                                              Limpiar
                                            </button> 
                                        </div> 
                                    </td>
                                    <td style="text-align:center;">
                                        <div class="form-group has-error input-group">
                                            ...
                                            <input style="font-size:12px;" tabindex="5" type="number" min="0" id="mes4" placeholder="Abril"  name="mes4" required  class="form-control suma_mes" onkeyup="suma_meses();">
                                            <span style="font-size:9px;" class="help-block with-errors"></span>
                                        </div>
                                        <div class="form-group has-error input-group">
                                            <span class="input-group-addon" style="font-size:12px;"><b> Setiembre</b></span>
                                            <input style="font-size:12px;" type="number" min="0" id="mes9" placeholder="Setiembre"  name="mes9" required  class="form-control suma_mes" tabindex="10" onkeyup="suma_meses();">
                                            <span style="font-size:9px;" class="help-block with-errors"></span>
                                        </div>
                                ...
                                <tr> 
                                    <td style="text-align:center;">
                                        <div class="form-group has-error input-group">
                                            <span class="input-group-addon" style="font-size:12px;"><b> Necesidad</b></span>
                                            <input style="font-size:12px;" tabindex="16" type="number" min="0" id="necesidad_anual_1" placeholder="Necesidad Anual"  name="necesidad_anual_1" required class="form-control necesidad1" onkeyup="sumar_necesidad2();">
                                            <span style="font-size:9px;" class="help-block with-errors"></span>
                                        </div>
                                        <div class="form-group has-error input-group">
                                            <span class="input-group-addon" style="font-size:12px;"><b> Mayo</b></span>
                                            <input style="font-size:12px;" type="number" tabindex="21"  min="0" id="mes5_1" placeholder="Mayo"  name="mes5_1" required  class="form-control suma_mes1" onkeyup="suma_meses1();">
                                            <span style="font-size:9px;" class="help-block with-errors"></span>
                                        </div>
                                        <div class="form-group has-error input-group">
                                            <span class="input-group-addon" style="font-size:12px;"><b> Octubre</b></span>
                                            <input style="font-size:12px;" tabindex="26" type="number" min="0" id="mes10_1" placeholder="Octubre"  name="mes10_1" required  class="form-control suma_mes1" onkeyup="suma_meses1();">
                                            <span style="font-size:9px;" class="help-block with-errors"></span>
                                        </div>
                                    </td>
                                    <td style="text-align:center;">
                                        <div class="form-group has-error input-group">
                                            <span class="input-group-addon" style="font-size:12px;"><b> Enero</b></span>
                                            <input style="font-size:12px;" tabindex="17" type="number" min="0" id="mes1_1" placeholder="Enero"  name="mes1_1" required  class="form-control suma_mes1" onkeyup="suma_meses1();">
                                            <span style="font-size:9px;" class="help-block with-errors"></span>
                                        </div>
                                        <div class="form-group has-error input-group">
                                            <span class="input-group-addon" style="font-size:12px;"><b> Junio</b></span>
                                            <input style="font-size:12px;" type="number" min="0" tabindex="22" id="mes6_1" placeholder="Junio"  name="mes6_1" required  class="form-control suma_mes1" onkeyup="suma_meses1();">
                                            <span style="font-size:9px;" class="help-block with-errors"></span>
                                        </div>
                                        <div class="form-group has-error input-group">
                                            <span class="input-group-addon" style="font-size:12px;"><b> Noviembre</b></span>
                                            <input style="font-size:12px;" tabindex="27" type="number" min="0" id="mes11_1" placeholder="Noviembre"  name="mes11_1"  required class="form-control suma_mes1" onkeyup="suma_meses1();">
                                            <span style="font-size:9px;" class="help-block with-errors"></span>
                                        </div> 
                                    </td>
                                    <td style="text-align:center;">
                                        <div class="form-group has-error input-group">
                                            <span class="input-group-addon" style="font-size:12px;"><b> Febrero</b></span>
                                            <input style="font-size:12px;" tabindex="18" type="number" min="0" id="mes2_1" placeholder="Febrero"  name="mes2_1" required   class="form-control suma_mes1" onkeyup="suma_meses1();">
                                            <span style="font-size:9px;" class="help-block with-errors"></span>
                                        </div>
                                        <div class="form-group has-error input-group">
                                            <span class="input-group-addon" style="font-size:12px;"><b> Julio</b></span>
                                            <input style="font-size:12px;" type="number" min="0" id="mes7_1" placeholder="Julio"  name="mes7_1" required  class="form-control suma_mes1" tabindex="23" onkeyup="suma_meses1();">
                                            <span style="font-size:9px;" class="help-block with-errors"></span>
                                        </div>
                                        <div class="form-group has-error input-group">
                                            <span class="input-group-addon" style="font-size:12px;"><b> Diciembre</b></span>
                                            <input style="font-size:12px;" tabindex="28" type="number" min="0" id="mes12_1" placeholder="Diciembre"  name="mes12_1"  required class="form-control suma_mes1" onkeyup="suma_meses1();">
                                            <span style="font-size:9px;" class="help-block with-errors"></span>
                                        </div> 
                                    </td>
                                    <td style="text-align:center;">
                                        <div class="form-group has-error input-group">
                                            <span class="input-group-addon" style="font-size:12px;"><b> Marzo</b></span>
                                            <input style="font-size:12px;" type="number" min="0" id="mes3_1" placeholder="Marzo"  name="mes3_1" required tabindex="19"  class="form-control suma_mes1" onkeyup="suma_meses1();">
                                            <span style="font-size:9px;" class="help-block with-errors"></span>
                                        </div>
                                        <div class="form-group has-error input-group">
                                            <span class="input-group-addon" style="font-size:12px;"><b> Agosto</b></span>
                                            <input style="font-size:12px;" type="number" min="0" id="mes8_1" placeholder="Agosto"  name="mes8_1" required  class="form-control suma_mes1" tabindex="24" onkeyup="suma_meses1();">
                                            <span style="font-size:9px;" class="help-block with-errors"></span>
                                        </div>
                                        <div class="form-group has-error input-group">
                                            <button type="button" tabindex="29"  onclick="getCopiar1()"> 
                                              Copiar
                                            </button>
                                            <button type="button" tabindex="30" onclick="getDividir1()"> 
                                              Dividir
                                            </button> 
                                            <button type="button" tabindex="31" onclick="limpiar_imput2()"> 
                                              Limpiar
                                            </button> 
                                        </div> 
                                    </td>
                                    <td style="text-align:center;">
                                        <div class="form-group has-error input-group">
                                            <span class="input-group-addon" style="font-size:12px;"><b> Abril</b></span>
                                            <input style="font-size:12px;" tabindex="20" type="number" min="0" id="mes4_1" placeholder="Abril"  name="mes4_1" required  class="form-control suma_mes1" onkeyup="suma_meses1();">
                                            <span style="font-size:9px;" class="help-block with-errors"></span>
                                        </div>
                                        <div class="form-group has-error input-group">
                                            <span class="input-group-addon" style="font-size:12px;"><b> Setiembre</b></span>
                                            <input style="font-size:12px;" tabindex="25" type="number" min="0" id="mes9_1" placeholder="Setiembre"  name="mes9_1" required  class="form-control suma_mes1" onkeyup="suma_meses1();">
                                            <span style="font-size:9px;" class="help-block with-errors"></span>
                                        </div>
                                ...
                                <tr> 
                                    <td style="text-align:center;">
                                        <div class="form-group has-error input-group">
                                            <span class="input-group-addon" style="font-size:12px;"><b> Necesidad</b></span>
                                            <input style="font-size:12px;" type="number" min="0" id="necesidad_anual_2" placeholder="Necesidad Anual" tabindex="32" name="necesidad_anual_2" required class="form-control necesidad2" onkeyup="sumar_necesidad3();">
                                            <span style="font-size:9px;" class="help-block with-errors"></span>
                                        </div>
                                        <div class="form-group has-error input-group">
                                            <span class="input-group-addon" style="font-size:12px;"><b> Mayo</b></span>
                                            <input style="font-size:12px;" type="number" tabindex="37" min="0" id="mes5_2" placeholder="Mayo"  name="mes5_2" required  class="form-control suma_mes2" onkeyup="suma_meses2();">
                                            <span style="font-size:9px;" class="help-block with-errors"></span>
                                        </div>
                                        <div class="form-group has-error input-group">
                                            <span class="input-group-addon" style="font-size:12px;"><b> Octubre</b></span>
                                            <input style="font-size:12px;" type="number" min="0" tabindex="42" id="mes10_2" placeholder="Octubre"  name="mes10_2" required  class="form-control suma_mes2" onkeyup="suma_meses2();">
                                            <span style="font-size:9px;" class="help-block with-errors"></span>
                                        </div>
                                    </td>
                                    <td style="text-align:center;">
                                        <div class="form-group has-error input-group">
                                            <span class="input-group-addon" style="font-size:12px;"><b> Enero</b></span>
                                            <input style="font-size:12px;" tabindex="33" type="number" min="0" id="mes1_2" placeholder="Enero"  name="mes1_2" required  class="form-control suma_mes2" onkeyup="suma_meses2();">
                                            <span style="font-size:9px;" class="help-block with-errors"></span>
                                        </div>
                                        <div class="form-group has-error input-group">
                                            <span class="input-group-addon" style="font-size:12px;"><b> Junio</b></span>
                                            <input style="font-size:12px;" type="number" min="0" tabindex="38" id="mes6_2" placeholder="Junio"  name="mes6_2" required  class="form-control suma_mes2" onkeyup="suma_meses2();">
                                            <span style="font-size:9px;" class="help-block with-errors"></span>
                                        </div>
                                        <div class="form-group has-error input-group">
                                            <span class="input-group-addon" style="font-size:12px;"><b> Noviembre</b></span>
                                            <input style="font-size:12px;" type="number" min="0" tabindex="43" id="mes11_2" placeholder="Noviembre"  name="mes11_2"  required class="form-control suma_mes2" onkeyup="suma_meses2();">
                                            <span style="font-size:9px;" class="help-block with-errors"></span>
                                        </div> 
                                    </td>
                                    <td style="text-align:center;">
                                        <div class="form-group has-error input-group">
                                            <span class="input-group-addon" style="font-size:12px;"><b> Febrero</b></span>
                                            <input style="font-size:12px;" tabindex="34" type="number" min="0" id="mes2_2" placeholder="Febrero"  name="mes2_2" required   class="form-control suma_mes2" onkeyup="suma_meses2();">
                                            <span style="font-size:9px;" class="help-block with-errors"></span>
                                        </div>
                                        <div class="form-group has-error input-group">
                                            <span class="input-group-addon" style="font-size:12px;"><b> Julio</b></span>
                                            <input style="font-size:12px;" type="number" tabindex="39" min="0" id="mes7_2" placeholder="Julio"  name="mes7_2" required  class="form-control suma_mes2" onkeyup="suma_meses2();">
                                            <span style="font-size:9px;" class="help-block with-errors"></span>
                                        </div>
                                        <div class="form-group has-error input-group">
                                            <span class="input-group-addon" style="font-size:12px;"><b> Diciembre</b></span>
                                            <input style="font-size:12px;" type="number" min="0" id="mes12_2" tabindex="44" placeholder="Diciembre"  name="mes12_2"  required class="form-control suma_mes2" onkeyup="suma_meses2();">
                                            <span style="font-size:9px;" class="help-block with-errors"></span>
                                        </div> 
                                    </td>
                                    <td style="text-align:center;">
                                        <div class="form-group has-error input-group">
                                            <span class="input-group-addon" style="font-size:12px;"><b> Marzo</b></span>
                                            <input style="font-size:12px;" type="number" tabindex="35" min="0" id="mes3_2" placeholder="Marzo"  name="mes3_2" required  class="form-control suma_mes2" onkeyup="suma_meses2();">
                                            <span style="font-size:9px;" class="help-block with-errors"></span>
                                        </div>
                                        <div class="form-group has-error input-group">
                                            <span class="input-group-addon" style="font-size:12px;"><b> Agosto</b></span>
                                            <input style="font-size:12px;" tabindex="40" type="number" min="0" id="mes8_2" placeholder="Agosto"  name="mes8_2" required  class="form-control suma_mes2" onkeyup="suma_meses2();">
                                            <span style="font-size:9px;" class="help-block with-errors"></span>
                                            <input type="hidden" name="nivel_farma" id="nivel_farma" value="1">
                                        </div>
                                        <div class="form-group has-error input-group">
                                            <button type="button" tabindex="45" onclick="getCopiar2()"> 
                                              Copiar
                                            </button> 
                                            <button type="button" tabindex="46"  onclick="getDividir2()"> 
                                              Dividir
                                            </button>
                                            <button type="button" tabindex="47"  onclick="limpiar_imput3()"> 
                                              Limpiar
                                            </button> 
                                        </div> 
                                    </td>
                                    <td style="text-align:center;">
                                        <div class="form-group has-error input-group">
                                            <span class="input-group-addon" style="font-size:12px;"><b> Abril</b></span>
                                            <input style="font-size:12px;" tabindex="36" type="number" min="0" id="mes4_2" placeholder="Abril"  name="mes4_2" required  class="form-control suma_mes2" onkeyup="suma_meses2();">
                                            <span style="font-size:9px;" class="help-block with-errors"></span>
                                        </div>
                                        <div class="form-group has-error input-group">
                                            <span class="input-group-addon" style="font-size:12px;"><b> Setiembre</b></span>
                                            <input style="font-size:12px;" type="number" tabindex="41" min="0" id="mes9_2" placeholder="Setiembre"  name="mes9_2" required  class="form-control suma_mes2" onkeyup="suma_meses2();">
                                            <span style="font-size:9px;" class="help-block with-errors"></span>
                                        </div>
                                    </td>
                                </tr>
                ...
                <div class="modal-footer">
                    <button id="guardar" tabindex="48" class="btn btn-primary btn-save">Guardar</button>
                    <button type="button" tabindex="49" class="btn btn-default" data-dismiss="modal">Cancelar</button>
                </div>
            </form>
        </div>
    </div>
