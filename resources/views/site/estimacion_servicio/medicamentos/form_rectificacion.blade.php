...
<div class="modal" id="modal-form-rect" tabindex="1" role="dialog" aria-hidden="true" data-backdrop="static">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-11 form-group has-error">                        
                            <div class="input-group">
                                ...
                                <textarea style="font-size:14px;" rows="2" id="descripcion" placeholder="descripcion"  name="descripcion" disabled class="form-control">                                    
                                </textarea>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-4 form-group has-error">
                            <div class="input-group">
                                ...
                                <input style="font-size:12px;" type="number" min="0" id="necesidad_actual" placeholder="Necesidad Anual" name="necesidad_actual" required class="form-control necesidad">
                        ...
                        <div class="col-md-3 form-group has-error">
                            <div class="input-group">
                                ...
                                <input style="font-size:12px;" type="number" min="0" id="necesidad_anual" placeholder="Necesidad Anual" name="necesidad_anual" disabled required class="form-control necesidad">
                                <span style="font-size:9px;" class="help-block with-errors"></span>
                            </div>                           
                        </div>
                        <div class="col-md-1">
