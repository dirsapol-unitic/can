...
@section('content')
    @if ($cerrado == 1)
                    ...
                    <div class="box-body">
                        ...
                        @if($nivel>1)
                            ...
                            <h1 class="pull-right">
                                ...
                                @endif
                                <a class="btn btn-app pull-right" target="_blank" href="{!! route('estimacion_servicio.exportDataNivel2y3',[$can_id,$establecimiento_id,$servicio_id,$tipo,'xlsx',1]) !!}">Excel <i class="fa fa-file-excel-o"></i>           
                                </a>
                        ...
                        @endif
                        @include('site.estimacion_servicio.medicamentos.form')
                    </div>
                </div>
                <div>
                <a href="{!! route('estimacion_servicio.index') !!}" class='btn btn-info'><i class="glyphicon glyphicon-hand-left"></i> Regresar</a>
        ...
        @else
            <div class="content">
                ...
                <div class="box box">
                    <div class="box-body">
                      No tienes autorización para ingresar a esta zona y
                    </div>
                </div>
    ...
    @else
            <div class="content">
                ...
                <div class="box box">
                    <div class="box-body">
                      No tienes autorización para ingresar a esta zona x
                    </div>
                </div>
                <div class="text-center">            
                </div>
