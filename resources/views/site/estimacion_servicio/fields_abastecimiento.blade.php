...
<!-- Stock Inestimacional Field -->
<div class="form-group col-sm-6">
    {!! Form::label('stock_inestimacional', 'Stock Inestimacional:') !!}
    {!! Form::number('stock_inestimacional', null, ['class' => 'form-control','id'=>'txt_suma_1','onchange'=>'sumar(this.value);']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    @if ($estimacion->tipo_dispositivo_id==1)
        <a href="{!! route('estimacion_servicio.cargar_medicamentos',[0,$estimacion->establecimiento_id]) !!}" class="btn btn-danger">Cancelar</a>
    
    @else
    
        <a href="{!! route('estimacion_servicio.cargar_dispositivos',[0,$estimacion->establecimiento_id]) !!}" class="btn btn-danger">Cancelar</a>
    @endif
