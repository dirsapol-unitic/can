...
<script type="text/javascript">
    ...
    function calculo() {
        ...
        $("#necesidad_anual").val(total_necesidad);
...
<div class="form-group col-sm-4">
    ...
    {!! Form::number('cpma', 0, ['class' => 'form-control cpm','required'=>'required','min'=>'0','onkeyup'=>'calculo()']) !!}
</div>
...
<div class="col-md-12">
    ...
    <div class="col-md-3 form-group">
        <span>Necesidad: </span> <span id="sNecesidad"></span>
    </div>
    <div class="col-md-3 form-group">
        <span>Total Prorrateo: </span> <span id="sProrroteo"></span>
    </div>
    <div class="col-md-5 form-group">
        <span>Falta para completar su Prorrateo: </span> <span id="sFalta"></span>
    </div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('estimacion.cargar_medicamentos',[$can_id,$establecimiento_id,$destino,1]) !!}" class="btn btn-danger">Cancelar <i class="glyphicon glyphicon-remove"></i></a>
</div>