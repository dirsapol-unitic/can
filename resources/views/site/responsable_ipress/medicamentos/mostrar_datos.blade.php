                ...
                <!--table id="example" class="stripe row-border order-column" cellspacing="0" -->  
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @if($nivel==1)
                                @if($estimacion->consolidado==4)
                                    <td colspan="4" bgcolor="#F2F2F2" style="text-align:center;">FARMACIA</td>
                                @else
                                    <td colspan="4" bgcolor="#F2F2F2" style="text-align:center;">ALMACEN</td>
                                @endif
                            @else
