        ...
        <tbody>
            <tr>
                ...
                @if($extra==0)   
                    @if($minutos!=0)   
                        <td>
                            <a data-toggle="tooltip" title="Editar Usuario!" href="{!! route('users.edit_responsable_rectificacion', [$user[0][2],'valor_id'=>0]) !!}" class='btn btn-primary btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
                        </td>
                    @endif
                @endif
            </tr>
            ...
            <tr>
                ...
                @if($extra==0)   
                    @if($minutos!=0)   
                            <td>
                                <a data-toggle="tooltip" title="Editar Usuario!" href="{!! route('users.edit_responsable_rectificacion', [$user[1][2],'valor_id'=>1]) !!}" class='btn btn-primary btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
                            </td>
                    @endif
                @endif
            </tr>
