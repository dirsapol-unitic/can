...
<div class="row">
    <div class="col-xs-12">
        ...
        <div><br/>
            Los archivos que se subiran deberan estar firmados y sellados por los responsables que han participado en el CAN2020, segun el RUBRO asignado por la IPRESS
            <br/><br/>
            ...
            <div class="box-body">
                <div class="row col-sm-12">
                     ...
                     <div class="form-group col-sm-12">                
                        ...
                        <div class="form-group col-sm-6">
                            {!! Form::label('photo', 'Extensiones permitidas(PDF,pdf,, xls, xlsx), archivo Max. 20MB:') !!}
