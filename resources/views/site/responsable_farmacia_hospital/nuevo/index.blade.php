...
@section('content')
    ...
    <div class="content">
        ...
        <div class="box box-primary">
            <div class="box-body">
                <div class="row">
                    {!! Form::open(['route' => ['farmacia_servicios.grabar_nuevo_medicamento_dispositivo',$establecimiento_id,$can_id,$destino],'method' => 'post']) !!}

                        @include('site.responsable_farmacia_hospital.nuevo.fields')
