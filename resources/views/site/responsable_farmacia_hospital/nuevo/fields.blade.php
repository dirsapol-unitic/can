...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('farmacia_servicios.editar_consolidado_farmacia_servicios',[$destino,$can_id]) !!}" class="btn btn-danger">Cancelar <i class="glyphicon glyphicon-remove"></i></a>
</div>