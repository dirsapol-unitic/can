        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
                ...
                <a target="_blank" data-toggle="tooltip" title="Medicamentos!" href="{{ route('farmacia_servicios.pdf_final_estimacion_nivel3_modificado',[$can_id,$establecimiento_id,1]) }}" class='btn bg-red btn-md margin'><i class="fa fa-medkit"></i></a>
                <a target="_blank" data-toggle="tooltip" title="Material Biomedico!" href="{{ route('farmacia_servicios.pdf_final_estimacion_nivel3_modificado',[$can_id,$establecimiento_id,2]) }}" class='btn bg-maroon btn-md margin'><i class="fa fa-fire-extinguisher"></i></a>
                <a target="_blank" data-toggle="tooltip" title="Instrumental Quirurgico!" href="{{ route('farmacia_servicios.pdf_final_estimacion_nivel3_modificado',[$can_id,$establecimiento_id,3]) }}" class='btn bg-primary btn-md margin'><i class="fa fa-bed"></i></a> 
                <a target="_blank" data-toggle="tooltip" title="Material e Insumos Odontológico!" href="{{ route('farmacia_servicios.pdf_final_estimacion_nivel3_modificado',[$can_id,$establecimiento_id,4]) }}"class='btn bg-aqua btn-md margin'><i class="fa fa-wrench"></i></a> 
                <a target="_blank" data-toggle="tooltip" title="Material e Insumo de Laboratorio!" href="{{ route('farmacia_servicios.pdf_final_estimacion_nivel3_modificado',[$can_id,$establecimiento_id,5]) }}" class='btn bg-olive btn-md margin'><i class="fa fa-hourglass-start"></i></a>            
                <a target="_blank" data-toggle="tooltip" title="Material Fotográfico y fonotécnico!" href="{{ route('farmacia_servicios.pdf_final_estimacion_nivel3_modificado',[$can_id,$establecimiento_id,6]) }}" class='btn bg-navy btn-md margin'><i class="fa fa-odnoklassniki-square"></i></a>            
                <a target="_blank" data-toggle="tooltip" title="Productos Afines!" href="{{ route('farmacia_servicios.pdf_final_estimacion_nivel3_modificado',[$can_id,$establecimiento_id,7]) }}" class='btn bg-orange btn-md margin'><i class="fa fa-hand-lizard-o"></i></a>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
