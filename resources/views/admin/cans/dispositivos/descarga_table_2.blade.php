                ...
                @foreach($estimaciones as $key => $estimacion)
                    ...
                    <!--table id="example" class="stripe row-border order-column" cellspacing="0" -->  
                        <thead>
                            <tr>
                                ...
                                <th bgcolor="#3c8dbc" style="text-align:center;">Observacion</th>
                                ...
                                <th bgcolor="#3c763d" style="text-align:center;">Observacion</th> 
                                <th bgcolor="#3c763d" style="text-align:center;">CPMA</th>
                                <th bgcolor="#3c763d" style="text-align:center;">Necesidad</th>
                    ...
                    ?>
                            ...
                            <td><small><?php
                                 ...
                                 ?></small></td>
                            <td style="text-align:center;"><small>{!! $estimacion->cpma_2 !!}</small></td>
                            <td style="text-align:center;"><small>{!! $estimacion->necesidad_anual_2 !!}</small></td>
                            <td style="text-align:center;"><small>{!! $estimacion->mes1_2 !!}</small></td>
                            <td style="text-align:center;"><small>{!! $estimacion->mes2_2 !!}</small></td>
                            <td style="text-align:center;"><small>{!! $estimacion->mes3_2 !!}</small></td>
                            <td style="text-align:center;"><small>{!! $estimacion->mes4_2 !!}</small></td>
                            <td style="text-align:center;"><small>{!! $estimacion->mes5_2 !!}</small></td>
                            <td style="text-align:center;"><small>{!! $estimacion->mes6_2 !!}</small></td>
                            <td style="text-align:center;"><small>{!! $estimacion->mes7_2 !!}</small></td>
                            <td style="text-align:center;"><small>{!! $estimacion->mes8_2 !!}</small></td>
                            <td style="text-align:center;"><small>{!! $estimacion->mes9_2 !!}</small></td>
                            <td style="text-align:center;"><small>{!! $estimacion->mes10_2 !!}</small></td>
                            <td style="text-align:center;"><small>{!! $estimacion->mes11_2 !!}</small></td>
                            <td style="text-align:center;"><small>{!! $estimacion->mes12_2 !!}</small></td>
                            </tr>
