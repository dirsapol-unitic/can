                    ...
                    ?>
                            ...
                            <tr>
                                ...
                                <?php
                                    ...
                                    $necesidad_anterior=$estimacion->stock_cero+$estimacion->stock_dos+$estimacion->stock_cuatro;
                                    if($estimacion->necesidad_anual==$necesidad_anterior)
                                        echo '<span>'.' '.'<span>';

                                    if($estimacion->necesidad_anual==$estimacion->stock_dos)
                                        echo '<span style="color:red;">'.' Eliminado '.'<span>';

                                    if($estimacion->necesidad_anual==$estimacion->stock_uno){
                                    ...
                                    if($estimacion->necesidad_anual!=$necesidad_anterior){
                                        $cpma_anterior=$estimacion->cpma_cero+$estimacion->cpma_dos+$estimacion->cpma_cuatro;
