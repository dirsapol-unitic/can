                        ...
                        <table id="example" class="stripe row-border order-column" cellspacing="0" >  
                            ...
                            <?php for($i=0;$i<$k;$i++){ ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($productos[$i][3]>0)
                                            <a onclick="ver_datos_nivel_1({!!$productos[$i][0]!!},{!!$productos[$i][1]!!})">{!! $productos[$i][3] !!}</a>
                                        @else
                                            {!! $productos[$i][3] !!}
                                        @endif
                                    ...
                                    <td>
                                        @if ($productos[$i][4]>0)
                                            <a onclick="ver_datos_nivel_2({!!$productos[$i][0]!!},{!!$productos[$i][1]!!})">{!! $productos[$i][4] !!}</a>
                                        @else
                                            {!!$productos[$i][4]!!}
                                        @endif
                                    ...
                                    <td>
                                        @if ($productos[$i][5]>0)
                                            <a onclick="ver_datos_nivel_3({!!$productos[$i][0]!!},{!!$productos[$i][1]!!})">{!! $productos[$i][5] !!}</a>
                                        @else
                                            {!!$productos[$i][5]!!}
                                        @endif
