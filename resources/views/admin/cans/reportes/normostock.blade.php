    ...
    <div class="col-xs-12">
        <div>
            <div class="box-header">
                <h3 class="box-title">Reportes de Productos en NormoStock, {!! $mes !!} - {!!$ano!!}</h3>
                <a class="btn btn-success pull-right" style="margin-top: -10px;margin-bottom: 5px" href="{!! route('abastecimiento.exportreportes',['can_id'=>$can_id,2,'xlsx']) !!}">Descargar <i class="fa fa-file-excel-o"></i></a>
            </div>
            <div class="box-body">
                ...
                <table id="example" class="table table-responsive table-striped">
                    ...
                    @foreach($indicadores as $key => $indicador)
                        <tr>
                            ...
                            <td>
                                <a href="{!! route('cans.descargar_productos',['can_id'=>$indicador->can_id,'establecimiento_id'=>$indicador->establecimiento_id,2]) !!}"><small>{!! $indicador->normostock_cantidad !!}</small></a>
                            </td>
                            ...
                            @else
                                ...
                                @endif
                            @endif
                            <td>{!! number_format($indicador->normostock_puntaje, 2, '.', ',') !!}</td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
