        ...
        <div class="box box-danger">
            <div class="box-body">
                <div class="box-header">
                    ...
                    <h1 class="pull-right"><a data-toggle="tooltip" title="clic para subir archivo" href="{!! route('cans.subiendo_archivos_rubro',['establecimiento_id'=>$establecimiento_id,'can_id'=>$can_id,'servicio_id'=>$servicio_id]) !!}" class='btn bg-blue'><i class="fa fa-upload"></i> Subir Observaciones </a></h1>
                </div>
                <div class="box-body">
                    <table id="example" class="table table-bordered table-striped">
                        <thead>
                        ...
                        @foreach($observaciones as $key => $observ)
                            <tr>
                                ...
                                <td>
                                    <a href="{!! route('cans.eliminar_observacion',['can_id'=>$can_id,'establecimiento_id'=>$establecimiento_id,'rubro_id'=>$servicio_id,'id'=>$observ->id]) !!}" class='btn bg-red'><i class="fa fa-trash""></i></a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
