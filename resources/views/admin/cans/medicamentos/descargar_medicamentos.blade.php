    ...
    <section class="content-header">
        ...
        <h1 class="pull-right">
            @if($num_estimaciones>0)
                @if($flat_estimacion==0)                
                    <div class="row no-print">
                        <div class="col-xs-12">
                            <a class="btn btn-app"  href="{!! route('cans.exportDataEstimacion',[$can_id,$establecimiento_id,$tipo,'xlsx']) !!}">Excel <i class="fa fa-file-excel-o"></i></a>
                            <!--a target="_blank" href="{{ route('cans.pdf_previo',[$can_id,$establecimiento_id,$tipo]) }}" class="btn btn-app">
                ...
                @else
                    <div class="row no-print">
                        <div class="col-xs-12">
                            <a class="btn btn-app"  href="{!! route('cans.exportDataConsolidado',[$can_id,$establecimiento_id,$tipo,'xlsx']) !!}">Excel <i class="fa fa-file-excel-o"></i></a>
                            <!--a target="_blank" href="{{ route('cans.pdf',[$can_id,$establecimiento_id,$tipo,0]) }}" class="btn btn-app">
                                <i class="fa fa-download"></i> PDF
                            </a-->
                        </div>
                    </div>
    ...
    <div class="content">
        ...
        <div class="box box">
            <div class="box-body">
              ...
              @if($tiempo==1)
                @include('admin.cans.medicamentos.descarga_table')
              @else
                @if($tiempo==2)
                    @include('admin.cans.medicamentos.descarga_table_2')
                @else
                    @include('admin.cans.medicamentos.descarga_table_3')
                @endif
              @endif
